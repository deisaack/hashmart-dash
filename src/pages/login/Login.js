            ...
            <Row>
              ...
              >
                <p className="text-center">Select A business</p>
                  <Widget>
                    <img style={{height: "40px"}} src="https://hashmart.co.ke/media/catalog/product/cache/ecd051e9670bd57df35c8f0b122d8aea/c/e/cet968_3_672x672-min.jpg" alt=""/>
                    <b style={{fontWeight: "bolt", fontSize: "1.5em" }}>Code for Entrepreneurs</b>
                  </Widget>
                <Widget style={{cursor: "pointer"}} onClick={this.funcs.logoutUser}>
                  <img style={{height: "40px"}} src="https://hashmart.co.ke/media/catalog/product/cache/ecd051e9670bd57df35c8f0b122d8aea/c/e/cet968_3_672x672-min.jpg" alt=""/>
                  <b style={{fontWeight: "bolt", fontSize: "1.5em" }} onClick={this.funcs.logoutUser}>Code for Entrepreneurs</b>
                  <i className="fa fa-arrow-right pull-right fa-2x" onClick={this.funcs.logoutUser} />
                </Widget>
                <p className="text-center"><a onClick={this.funcs.logoutUser}>Use another Account</a></p>
              </Col>
            </Row>
        )}
