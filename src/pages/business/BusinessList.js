...
class BusinessList extends Component {
  ...
  submitForm = () => {
    let data = {
      ...
      // "status": "string",
      // "active": "string",
      ownerCode: this.state.user.value
    };
    ...
    return (
      <div>
        ...
        <h1 className="page-title mb-lg">
          <span className="fw-semi-bold">Businesses</span>
        </h1>
        {this.state.addBusiness ? (
          <Widget title={<h5>Create A Business</h5>} settings close>
            <Form>
              <Row form>
                <Col md={6}>
                  <FormGroup>
              ...
              <Row form>
                <Col md={6}>
                  <FormGroup>
                    <Label for="ownerCode">Owner</Label>
                    <Select
                      options={this.state.users}
                      onInputChange={value => this.onOptionChange(value)}
            ...
            <Widget
              title={
                <Row style={{ marginBottom: "5px" }}>
                  <Col sm={8}>
                    <h5>
                      All <span className="fw-semi-bold">businesses</span>
                    </h5>
                  </Col>
                  <Col sm={4}>
                ...
                <tbody>
                  {this.state.businessList.map((item, key) => (
                    <tr key={key}>
                      ...
                      <td>{item.status}</td>
                      <td>
                        <Link to={`/app/business/${item.companyCode}`}>
