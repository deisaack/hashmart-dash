...
class BusinessDetail extends Component {
  ...
  componentDidMount() {
    ...
    this.services.getBusinessProducts(this.getCode());
    this.services.getBusinessOrders(this.getCode());
  }
    ...
    return (
      <div className={s.root}>
        ...
        <h1 className="page-title mb-lg">
          <span className="fw-semi-bold">Mama Sasha Shop</span>
        </h1>
        <Row>
          <Col sm={12}>
            <Widget>
                ...
                <tbody>
                  {this.state.productList.map((item, key) => (
                    <tr key={key}>
                      ...
                      <td>
                        <Link to={`/app/product/${item.productCode}`}>
